...
public class FuncionariosDAO {
    ...
    public void alterarFuncionario(Funcionarios obj) {
        ...
        //Metodo Alterar Funcionario
    public void alterarSenhaFuncionario (Funcionarios obj) {
        try {

            //1 passo  - criar o comando sql
            String sql = "update tb_funcionarios set senha=? where id=?";
    ...
    public Funcionarios consultaPorNome(String nome) {
        ...
        //metodo consultaCliente  por Nome
    public Funcionarios consultaPorNomeESenha(String email, String senha) {
        try {
            //1 passo - criar o sql , organizar e executar.
...
//Caso o usuario seja do tipo limitado 
                    ...
                    tela.menuItemVendasDoDia.setEnabled(false);
                    tela.menuItemControleDeVendas.setVisible(false);
